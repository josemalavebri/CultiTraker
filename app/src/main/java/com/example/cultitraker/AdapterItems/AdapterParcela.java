...
public class AdapterParcela extends RecyclerView.Adapter<AdapterParcela.ViewHolder>{
    ...
    public AdapterParcela(ArrayList<AdapterModel> listaDatos, Context context, int layoutId) {
    ...
    @NonNull
    @Override
    public AdapterParcela.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
