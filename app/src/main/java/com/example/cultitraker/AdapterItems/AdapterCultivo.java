...
public class AdapterCultivo extends RecyclerView.Adapter<AdapterCultivo.ViewHolder>{
    ...
    public AdapterCultivo(ArrayList<AdapterModel> listaDatos, Context context, int layoutId) {
    ...
    @NonNull
    @Override
    public AdapterCultivo.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btn_Eliminar = itemView.findViewById(R.id.btn_EliminarCultivo);
        }
    }
}
