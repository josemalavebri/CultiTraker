...
public class AdapterRiego extends RecyclerView.Adapter<AdapterRiego.ViewHolder>{
    ...
    public AdapterRiego(ArrayList<AdapterModel> listaDatos, Context context, int layoutId) {
    ...
    @NonNull
    @Override
    public AdapterRiego.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btn_Eliminar = itemView.findViewById(R.id.btn_EliminarRiego);
        }
    }
}
